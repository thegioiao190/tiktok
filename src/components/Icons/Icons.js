...
export const HomeIconActive = ({ width = '3.2rem', height = width, className }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const HomeIcon = ({ width = '3.2rem', height = width, className }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const UsersIcon = ({ width = '3.2rem', height = width, className }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const UsersIconActive = ({ width = '3.2rem', height = width, className }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const LiveIcon = ({ width = '3.2rem', height = width, className }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const LiveIconActive = ({ width = '3.2rem', height = width, className }) => {
    return (
        <svg
            width={width}
            height={height}
